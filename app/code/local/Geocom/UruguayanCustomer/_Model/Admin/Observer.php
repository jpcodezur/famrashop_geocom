 ...
 */
class Geocom_UruguayanCustomer_Model_Admin_Observer
{
    ...
    public function actionPreDispatchAdmin($observer)
    {
        ...
        if($this->isLogoutAction($request)){
            if($this->isCCAdmin()){
                ...
                $session->addSuccess(Mage::helper('adminhtml')->__('You have logged out.'));
    ...
    private function isLogoutAction($request){
       return ($request->getActionName()==="logout");
    }
